...
public class TestTimestampWithTimeZoneFunction extends AbstractTestFunctions
{
    ...
    {
        assertFunction("yesterday(TIMESTAMP '2001-01-02 03:04:05.321 +07:09')",
                createTimestampWithTimeZoneType(3),
                SqlTimestampWithTimeZone.newInstance(3, new DateTime(2001, 1, 1, 3, 4, 5, 321, BERLIN_ZONE).getMillis(), 0, BERLIN_TIME_ZONE_KEY));
    }
}